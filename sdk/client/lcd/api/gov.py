...
from sdk.core import Coins, Dec
from sdk.core.deposit import Deposit
from sdk.core.gov import Proposal, ProposalStatus, WeightedVoteOption
from sdk.core.gov.data import Vote
...
class AsyncGovAPI(BaseAsyncAPI):
    ...
    ) -> List[List[Proposal], dict]:
        """Fetches all proposals.
        Args:
            options (dict, optional): dictionary containing options. Defaults to {}. you can use one or more below:
                {
                    "proposal_status": sdk.core.gov.ProposalStatus (int)
                    "voter": voter address (str),
                    "depositor": depositor address(str)
                }
                example) {"proposal_status":1, "depositor":"cosmos17lmam6zguazs5q5u6z5mmx76uj63gldnse2pdp"}
