...
from sdk.core.compact_bit_array import CompactBitArray
from sdk.core.fee import Fee
from sdk.core.mode_info import ModeInfo, ModeInfoMulti, ModeInfoSingle
from sdk.core.msg import Msg
from sdk.core.public_key import (
    LegacyAminoMultisigPublicKey,
    PublicKey,
    SimplePublicKey,
)
from sdk.core.signature_v2 import SignatureV2
...
class TxInfo(JSONSerializable):
    ...
    .. note::
        ...
        :meth:`TxAPI.tx_info()<sdk.client.lcd.api.tx.TxAPI.tx_info>`
    """
